...
const productData = {
  hoodies: [
    ...
    { img: hoodieImg, name: "Blue Hoodie", price: "$25" },
    { img: hoodieImg, name: "Grey Hoodie", price: "$30" },
    { img: hoodieImg, name: "Green Hoodie", price: "$35" },
    { img: hoodieImg, name: "Red Hoodie", price: "$15" },
